...
// urlpatterns = [
//     path('test/', test_view),
//     path('signup/', SignupAPIView.as_view()),n
//     path('login/', RoleLoginAPIView.as_view()),n

//     path('forgot-password/', RequestPasswordResetAPIView.as_view()),n
//     path('reset-password/', ResetPasswordAPIView.as_view()),n
//     path('verify-otp/', VerifyOTPAPIView.as_view()),n
//     path('resend-otp/', ResendOTPAPIView.as_view()),n
...
//     # mobile no verify
//     path("send-sms/", SendOTPAPIView.as_view(), name="send-otp"),n
//     path("verify-sms/", VerifySMSOTPAPIView.as_view(), name="verify-otp"),n
...
//     path("experience/<int:id>/", ExperienceAPIView.as_view(), name="experience"),
    
//     path("proposers/", ProposersAPIView.as_view(), name="proposers"), n
//     path("qualification/", QualificationAPIView.as_view(), name="qualification"),
//     path("qualification/<int:id>/", QualificationAPIView.as_view(), name="qualification"),
...
//       path('add-member/<uuid:member_id>/', AddMember.as_view(), name='user-api'),
