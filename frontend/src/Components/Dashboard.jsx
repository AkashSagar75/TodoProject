...
import { useNavigate } from 'react-router-dom';
 import { totalTask } from '../ApiServices/Api';
      ...
      const [totalemployee, settotalemployee] = useState([]);
       ...
       useEffect(()=>{
         const fatchData = async ()=>{
          try {
             const res = await  totalTask(token);
              console.log("total employee Data", res)
  ...
  return (
    <>
      ...
      <div className="flex items-center gap-4 bg-white shadow-md rounded-xl p-6 hover:shadow-lg transition">
        ...
        <div>
          <h2 className="text-2xl font-bold text-gray-700">{totalemployee.totalEmployees
      ...
      <div className="flex items-center gap-4 bg-white shadow-md rounded-xl p-6 hover:shadow-lg transition">
        ...
        <div>
          <h2 className="text-2xl font-bold text-gray-700">{totalemployee.activeEmployees}</h2>
      ...
      <div className="flex items-center gap-4 bg-white shadow-md rounded-xl p-6 hover:shadow-lg transition">
        ...
        <div>
          <h2 className="text-2xl font-bold text-gray-700">{totalemployee.pendingTasks}</h2>
